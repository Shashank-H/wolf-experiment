...
export function OrdersPage() {
  ...
  return (
    <Card title="Orders">
      ...
      <p className="note">Orders are read-only broker/history records or dry-run simulations. Wolf does not cancel regular broker orders; use the GTT page for live broker-side actions.</p>
