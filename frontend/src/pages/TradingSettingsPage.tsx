      ...
      <div className="settings-grid">
        ...
        <Card title="Risk limits" marker="[R]">
          ...
          <form onSubmit={saveTrading} className="stack" autoComplete="off">
            <div className="field-grid">
              <Field label="Daily loss" info="Guides LLM GTT proposal sizing and manual review; this is not broker-wide realized daily PnL blocking yet. Default ₹5,000."><input value={trading.maxDailyLoss} onChange={(e) => setTrading({ ...trading, maxDailyLoss: e.target.value })} name="maxDailyLoss" type="number" min="0" autoComplete="off" /></Field>
              <Field label="Trades / day" info="Guides how many app GTT proposals the LLM should create for review. Default 5."><input value={trading.maxTradesPerDay} onChange={(e) => setTrading({ ...trading, maxTradesPerDay: e.target.value })} name="maxTradesPerDay" type="number" min="0" autoComplete="off" /></Field>
              <Field label="Capital / trade" info="Guides LLM sizing for each draft GTT proposal. Default ₹25,000."><input value={trading.maxCapitalPerTrade} onChange={(e) => setTrading({ ...trading, maxCapitalPerTrade: e.target.value })} name="maxCapitalPerTrade" type="number" min="0" autoComplete="off" /></Field>
              <Field label="Open positions" info="Guides LLM proposal selection around simultaneous positions for manual review. Default 3."><input value={trading.maxOpenPositions} onChange={(e) => setTrading({ ...trading, maxOpenPositions: e.target.value })} name="maxOpenPositions" type="number" min="0" autoComplete="off" /></Field>
            </div>
